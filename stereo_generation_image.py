...
def run(model_path):
    ...
    img_list = [i for i in img_list if i == '*.png' or i == '*.jpg']
    img_list.sort()
    ...
    for idx in tqdm(range(len(img_list))):
        ...
        # Write the left and right overlapped together as a .gif file.
        output_gif = os.path.join(output_dir,'MiDaS_{}.gif'.format(sample.split('.')[0]))
        create_gif(left_img,right_img,output_gif)
